              ...
              appBar: AppBar(
                ...
                title: Row(children: [
                  CircleAvatar(
                    radius: 20.0,
                    child: Image.network(
                      '${context.watch<HomePatientCubit>().doctorModel!.image}',
                    ),
                  ),
                  const SizedBox(
                    width: 10.0,
                  ...
                  Text(
                      '${context.watch<HomePatientCubit>().doctorModel!.name}'),
                ]),
                centerTitle: true,
              ),
                          ...
                          itemBuilder: (context, index) {
                            if (context
                              ...
                              return doctorMessage(
                                  context.watch<HomePatientCubit>().messageList,
                                  index);
                            }
